public abstract class Falco
{
    public static String[] subList = 
    {
      ...
      "Up Throw", 
      "Down Throw",
      "Blaster Start (Ground)", "Blaster Loop (Ground)",
      "Blaster End (Ground)", "Blaster Start (Aerial)",
      "Blaster Loop (Aerial)", "Blaster End (Aerial)",
      "Falco Phantasm Start (Ground)", "Falco Phantasm (Ground)", "Falco Phantasm End (Ground)",
      "Falco Phantasm Start (Aerial)", "Falco Phantasm (Aerial)", "Falco Phantasm End (Aerial)",
      "Fire Bird Start (Ground)", "Fire Bird Start (Aerial)", "Fire Bird",
      "Fire Bird Landing", "Fire Bird Fall", "Fire Bird Bounce",
    ...
    public static String getSubactionID(String atk)
    {
        ...
        switch (atk)
        {
            ...
            case "Falco Phantasm Start (Ground)": ID = "12D"; break; 
            case "Falco Phantasm (Ground)": ID = "12E"; break; 
            case "Falco Phantasm End (Ground)": ID = "12F"; break; 
            case "Falco Phantasm Start (Aerial)": ID = "130"; break; 
            case "Falco Phantasm (Aerial)": ID = "131"; break; 
            case "Falco Phantasm End (Aerial)": ID = "132"; break; 
            case "Fire Bird Start (Ground)": ID = "133"; break;  
            case "Fire Bird Start (Aerial)": ID = "134"; break; 
            case "Fire Bird": ID = "135"; break; 
            case "Fire Bird Landing": ID = "136"; break; 
            case "Fire Bird Fall": ID = "137"; break; 
            case "Fire Bird Bounce": ID = "138"; break; 
