public abstract class DrMario
{
    public static String[] subList = 
    {
      ...
      "Up Throw", 
      "Down Throw",
      "Megavitamin (Ground)", "Megavitamin (Aerial)",
      "Super Sheet (Ground)", "Super Sheet (Aerial)", "Super Jump Punch (Ground)",
      "Super Jump Punch (Aerial)", "Dr. Tornado (Ground)", "Dr. Tornado (Aerial)",
    };
    /**
    ...
    public static String getSubactionID(String atk)
    {
        ...
        switch (atk)
        {
            ...
            case "Megavitamin (Ground)": ID = "127"; break;
            case "Megavitamin (Aerial)": ID = "128"; break;
            case "Super Sheet (Ground)": ID = "129"; break; 
            case "Super Sheet (Aerial)": ID = "12A"; break; 
            case "Super Jump Punch (Ground)": ID = "12B"; break;  
            case "Super Jump Punch (Aerial)": ID = "12C"; break;
            case "Dr. Tornado (Ground)": ID = "12D"; break;
            case "Dr. Tornado (Aerial)": ID = "12E"; break;
        }
        return ID;
    }
}