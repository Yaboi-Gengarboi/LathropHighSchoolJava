public abstract class Luigi
{
    ...
    public static String getSubactionID(String atk)
    {
        ...
        switch (atk)
        {
            ...
            case "Missfire Start (Ground)": ID = "129"; break; 
            case "Missfire Charge (Ground)": ID = "12A"; break; 
            case "Missfire 1 (Ground)": ID = "12B"; break;
            case "Missfire 2 (Ground)": ID = "12C"; break;
            case "Missfire 3 (Ground)": ID = "12D"; break;
            case "Missfire End (Ground)": ID = "12E"; break;
            case "Missfire Start (Aerial)": ID = "129"; break; 
            case "Missfire Charge (Aerial)": ID = "130"; break; 
            case "Missfire 1 (Aerial)": ID = "131"; break;
            case "Missfire 2 (Aerial)": ID = "132"; break;
            case "Missfire End (Aerial)": ID = "133"; break;
            case "Super Jump Punch (Ground)": ID = "134"; break;  
            case "Super Jump Punch (Aerial)": ID = "135"; break;
            case "Luigi Cyclone (Ground)": ID = "136"; break;
            case "Luigi Cyclone (Aerial)": ID = "137"; break;
        }
        return ID;
    }
}