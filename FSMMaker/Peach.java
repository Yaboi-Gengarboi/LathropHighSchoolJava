public abstract class Peach
{
    public static String[] subList = 
    {
      ...
      "Up Tilt", 
      "Down Tilt",
      "Side Smash (Golf Club)",
      "Side Smash (Frying Pan)", 
      "Side Smash (Tennis Racket)", 
      "Up Smash", 
      "Down Smash",
      "Neutral Aerial", 
      "Foward Aerial",
    ...
    public static String getSubactionID(String atk)
    {
        ...
        switch (atk)
        {
            ...
            case "Side Smash (Golf Club)": ID = "12A"; break;
            case "Side Smash (Frying Pan)": ID = "12B"; break;
            case "Side Smash (Tennis Racket)": ID = "12C"; break;
            ...
            case "Toad Counter (Ground)": ID = "12D"; break;
            case "Toad Hit (Ground)": ID = "139"; break;
            case "Toad Counter (Aerial)": ID = "13A"; break;
            case "Toad Hit (Aerial)": ID = "13B"; break;
            case "Peach Bomber Start (Ground)": ID = "12E"; break;
            case "Peach Bomber End (Ground)": ID = "12F"; break;
            case "Peach Bomber Jump": ID = "130"; break;
            case "Peach Bomber Start (Aerial)": ID = "131"; break;
            case "Peach Bomber End 1 (Aerial)": ID = "132"; break;
            case "Peach Bomber End 2 (Aerial)": ID = "133"; break;
            case "Peach Parasol Start (Ground)": ID = "134"; break;
            case "Peach Parasol End (Ground)": ID = "135"; break;
            case "Peach Parasol Start (Aerial)": ID = "136"; break;
            case "Peach Parasol End (Aerial)": ID = "137"; break;
            case "Vegetable": ID = "138"; break;
        }
        return ID;
    }
}