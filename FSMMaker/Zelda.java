...
{      
    ...
    public static String getSubactionID(String atk)
    {
        ...
        switch (atk)
        {
            ...
            case "Nayru's Love (Ground)": ID = "127"; break;
            case "Nayru's Love (Aerial)": ID = "128"; break;
            case "Din's Fire Start (Ground)": ID = "129"; break;
            case "Din's Fire Loop (Ground)": ID = "12A"; break;
            case "Din's Fire End (Ground)": ID = "12B"; break;
            case "Din's Fire Start (Aerial)": ID = "12C"; break;
            case "Din's Fire Loop (Aerial)": ID = "12D"; break;
            case "Din's Fire End (Aerial)": ID = "12E"; break;
            case "Farore's Wind Start (Ground)": ID = "12F"; break;
            case "Farore's Wind (Ground)": ID = "130"; break;
            case "Farore's Wind Start (Aerial)": ID = "131"; break;
            case "Farore's Wind (Aerial)": ID = "132"; break;
            case "Transform 1 (Ground)": ID = "133"; break;
            case "Transform 2 (Ground)": ID = "134"; break;
            case "Transform 1 (Aerial)": ID = "135"; break;
            case "Transform 2 (Aerial)": ID = "136"; break;
        }
        return ID;
    }
}